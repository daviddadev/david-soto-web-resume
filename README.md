...
This project is part of my coding boot camp homework series. The project purpose was to build a online resume with HTML and Bootstrap.

Feel free to look at my projects. If you want to drop a line visit my personal [website](http://davidsoto.dev/).

## Launch

To see the project live tap [here](https://daviddadev.github.io/david-soto-web-resume/index.html), and thanks for visiting my GitHub. Enjoy.
